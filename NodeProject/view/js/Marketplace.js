var funds = 16471.91; //just some number
var inventory = [];
...
'<p> Core i3<br> 8GB Memory<br> 1TB Hard Drive</p>', 500.99, "Computer", '<img class="mr-3" src="http://via.placeholder.com/120x120" alt="Generic placeholder image">');
